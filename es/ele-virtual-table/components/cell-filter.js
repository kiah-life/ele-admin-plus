import { defineComponent, ref, computed, openBlock, createElementBlock, withModifiers, createVNode, withCtx, Fragment, unref, renderList, createBlock, createElementVNode, createTextVNode, toDisplayString, normalizeClass } from "vue";
import { useLocale, ElScrollbar, ElCheckboxGroup, ElCheckbox, ElButton, ElIcon } from "element-plus";
            ...
            __props.filterMultiple ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              createElementVNode("div", {
                class: normalizeClass([
                  ...
                  { "is-active": filteredValue.value == null }
                ]),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.filters, (d) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  class: normalizeClass([
                    "ele-table-filter-item",
                    { "is-active": filteredValue.value === d.value }
                  ]),
