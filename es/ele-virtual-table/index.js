import { defineComponent, ref, reactive, computed, onActivated, onDeactivated, watch, nextTick, openBlock, createElementBlock, normalizeClass, unref, createBlock, mergeProps, createSlots, withCtx, renderList, renderSlot, normalizeProps, guardReactiveProps, createCommentVNode, toDisplayString, createVNode } from "vue";
          ...
          row: withCtx((rowProps) => {
            ...
            return [
              rowProps && rowProps.rowData && rowProps.rowData.isExpandRow ? (openBlock(), createBlock(ExpandRow, {
                key: 0,
                column: (_a = tableExpandCol.value) == null ? void 0 : _a.originalCol,
