import { defineComponent, ref, shallowRef, computed, markRaw, watch, unref, shallowReactive, provide, nextTick, onMounted, openBlock, createBlock, normalizeClass, createSlots, withCtx, createCommentVNode, renderSlot, renderList, normalizeProps, guardReactiveProps } from "vue";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(EleAdminLayout, {
        ...
        body: withCtx(() => [
          _ctx.tabBar && _ctx.keepAlive ? (openBlock(), createBlock(ProIframe, {
            key: 0,
