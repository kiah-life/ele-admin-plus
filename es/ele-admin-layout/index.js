import { defineComponent, shallowRef, computed, shallowReactive, provide, watch, nextTick, onMounted, openBlock, createBlock, normalizeClass, normalizeStyle, withCtx, createElementBlock, renderSlot, createElementVNode, createCommentVNode, toDisplayString, mergeProps, createSlots, normalizeProps, guardReactiveProps, renderList, createVNode, unref, Fragment } from "vue";
      ...
      return openBlock(), createBlock(LayoutSkeleton, {
        ...
        side: withCtx(() => [
          !isTopLayout.value ? (openBlock(), createElementBlock("div", {
            ...
            style: normalizeStyle({ height: isFixedSidebar.value ? layoutHeight.value : void 0 })
          }, [
              ...
              createVNode(unref(ElScrollbar), {
                ...
                default: withCtx(() => [
                  _ctx.sidebarMenus ? (openBlock(), createBlock(EleMenus, mergeProps({
                    ...
                    uniqueOpened: true,
                    collapseTransition: false,
                    theme: isMixSidebar.value && !isDarkMixSidebar.value ? void 0 : _ctx.sidebarStyle,
