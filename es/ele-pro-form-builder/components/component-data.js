...
const codeTips = "/* 全局变量 `form`(表单数据), `items`(全部表单项), `searchExpand`(展开状态),\n * `getProFormRefs`(获取组件引用), `httpRequest`(请求工具) */";
const vIfCodeTips = "/* 全局变量 `form`(表单数据), `items`(全部表单项), `searchExpand`(展开状态) */";
