...
declare const __VLS_component: import('vue').DefineComponent<import('vue').ExtractPropTypes<{
    modelValue: import('vue').PropType<TemplateFormConfig>;
    headerTools: {
        type: import('vue').PropType<boolean | HeaderRightToolName[]>;
        default: () => boolean;
    };
    ...
    "update:modelValue": (_config: TemplateFormConfig) => void;
    ...
    "onUpdate:modelValue"?: ((_config: TemplateFormConfig) => any) | undefined;
