import { defineComponent, ref, computed, onMounted, onBeforeUnmount, openBlock, createElementBlock, normalizeClass, createElementVNode, normalizeStyle, unref, renderSlot, Fragment, renderList } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const autoIntoView = () => {
      ...
      const pw = (pEl == null ? void 0 : pEl.offsetWidth) || 0;
      const ph = (pEl == null ? void 0 : pEl.offsetHeight) || 0;
      const el = bodyRef.value;
      const w = (el == null ? void 0 : el.offsetWidth) || 0;
      const h = (el == null ? void 0 : el.offsetHeight) || 0;
    ...
    const { handleMousedown, handleTouchstart } = useMoveEvent({
      ...
      move: ({ distanceX, distanceY, e }) => {
        if (startX == null || startY == null || distanceX == null || distanceY == null) {
          return;
        }
        e.preventDefault();
        e.stopPropagation();
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ref_key: "viewerRef",
        ref: viewerRef,
        class: normalizeClass(["ele-viewer"])
      }, [
        createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            createElementVNode("div", {
              ...
              style: normalizeStyle([_ctx.contentStyle || {}, { transform: imageTransform.value }]),
