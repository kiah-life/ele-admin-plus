...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const cascaderPropsOption = vue.reactive({
      ...props$1.props || {},
      multiple: !!(props$1.multiple || ((_a = props$1.props) == null ? void 0 : _a.multiple))
    });
    vue.watch(
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElCascader), vue.mergeProps(vue.unref(core.omit)(_ctx.$props, ["props", "options", "multiple"]), {
        ref_key: "cascaderRef",
        ref: cascaderRef,
