  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
        (vue.openBlock(), vue.createElementBlock(vue.Fragment, null, vue.renderList(2, (index) => {
          return vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              ...
              index === 1 ? (vue.openBlock(), vue.createBlock(vue.unref(icons.SvgIcon), {
                key: 0,
                name: "ArrowDown",
                size: "sm",
                style: { transform: "scale(0.8)" }
              })) : (vue.openBlock(), vue.createBlock(vue.unref(icons.SvgIcon), {
                key: 1,
                name: "ArrowRight",
                size: "sm",
                color: "placeholder",
            ...
            index === 1 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2, [
              vue.createVNode(vue.unref(icons.IconSkeleton), { size: "xs" }),
              vue.createVNode(vue.unref(icons.IconSkeleton), {
                size: "xs",
