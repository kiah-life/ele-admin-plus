...
import { ComponentGroup, TemplateFormConfig } from '../types';
 ...
 */
export declare function generateFooterCode(config: TemplateFormConfig, showFooterExpand?: boolean): string;
/**
 ...
 */
export declare function generateContentCode(config: TemplateFormConfig, showFooterExpand: boolean | undefined, componentData?: ComponentGroup[], itemTypeData?: ProFormItemTypeData[]): string;
/**
 * 获取上传组件表单验证方法代码
 * @param item 表单项
 */
 ...
 * @param itemTypeData 高级表单组件类型数据
 */
export declare function generateRuleCode(items: ProFormItemProps[], componentData?: ComponentGroup[], itemTypeData?: ProFormItemTypeData[]): any;
/**
 ...
 * @param config 表单配置
 */
export declare function getImportAndVarCode(config: TemplateFormConfig): {
    imports: string[];
    codes: string[];
    proImports: string[];
    proCodes: string[];
 ...
 * @param itemTypeData 高级表单组件类型数据
 */
export declare function generateElFormCode(data?: TemplateFormConfig, componentData?: ComponentGroup[], itemTypeData?: ProFormItemTypeData[]): string;
/**
 * 生成 ProForm 代码
 * @param data 表单配置数据
 */
export declare function generateProFormCode(data?: TemplateFormConfig): string;
