        ...
        default: vue.withCtx(() => [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.items, (item, index) => {
            return vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElTabPane), vue.mergeProps({
              ...
              ref_for: true
            }, vue.unref(core.omit)(item, ["slot", "meta"])), vue.createSlots({
              label: vue.withCtx(() => [
                ...
                tabType.value === "simple" || tabType.value === "indicator" ? (vue.openBlock(), vue.createBlock(vue.unref(elementPlus.ElIcon), {
                  key: 0,
