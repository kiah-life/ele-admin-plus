              ...
              return vue.openBlock(), vue.createElementBlock("div", {
                ...
                col.data ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
                  vue.createElementVNode("div", _hoisted_2, [
                    ...
                    vue.createVNode(vue.unref(elementPlus.ElIcon), vue.mergeProps({
                      ...
                      default: vue.withCtx(() => [
                        vue.renderSlot(_ctx.$slots, "itemIcon", {
                          ...
                          }, null, 8, ["style"])) : col.data.type === "danger" ? (vue.openBlock(), vue.createBlock(vue.unref(icons.CloseCircleFilled), {
                            key: 1,
                            style: vue.normalizeStyle(col.data.iconStyle)
                          }, null, 8, ["style"])) : (vue.openBlock(), vue.createBlock(vue.unref(icons.CheckCircleFilled), {
                            key: 2,
                            style: vue.normalizeStyle(col.data.iconStyle)
                          }, null, 8, ["style"]))
                        ])
