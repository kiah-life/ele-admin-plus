  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("td", {
        ...
        "expand" === ((_a = __props.col.column) == null ? void 0 : _a.type) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
          __props.col.text ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 0 }, [
