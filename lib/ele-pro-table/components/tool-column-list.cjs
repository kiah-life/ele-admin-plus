            ...
            vue.createElementVNode("div", _hoisted_2, [
              __props.sortable ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3, [
                vue.createVNode(vue.unref(elementPlus.ElIcon), null, {
                  default: vue.withCtx(() => [
                    vue.createVNode(vue.unref(icons.HolderOutlined))
                  ]),
                  _: 1
                })
              ...
              __props.allowFixed ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5, [
                vue.createElementVNode("div", {
                  ...
                  vue.createVNode(vue.unref(elementPlus.ElIcon), null, {
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(icons.VerticalRightOutlined))
                    ]),
                    _: 1
                  })
                ], 42, _hoisted_6),
                vue.createElementVNode("div", {
                  ...
                  vue.createVNode(vue.unref(elementPlus.ElIcon), null, {
                    default: vue.withCtx(() => [
                      vue.createVNode(vue.unref(icons.VerticalLeftOutlined))
                    ]),
                    _: 1
                  })
                ], 42, _hoisted_7)
