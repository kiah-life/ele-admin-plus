...
export const adminLayoutProps = {
  ...
  /** 是否需要页签栏 */
  tabBar: [Boolean, String] as PropType<TabBar>,
  /** 是否需要面包屑导航 */
  breadcrumb: [Boolean, Object] as PropType<boolean | EleBreadcrumbProps>,
  /** 是否需要返回顶部 */
  backTop: [Boolean, Object] as PropType<boolean | EleBacktopProps>,
  /** 顶栏菜单属性 */
  ...
  /** 侧栏风格 */
  sidebarStyle: String as PropType<SidebarStyle>,
  /** 页签风格 */
  tabStyle: {
