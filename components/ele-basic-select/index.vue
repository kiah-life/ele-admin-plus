  ...
  >
    ...
    >
      <ElInput
        ...
        :readonly="!filterable || !visible || multiple"
        :style="inputStyle"
...
<script lang="ts" setup>
  ...
  import { ArrowDown, CloseCircleFilled } from '../icons';
  import EleTooltip from '../ele-tooltip/index.vue';
  import ReceiverView from '../ele-config-provider/components/receiver-view.vue';
